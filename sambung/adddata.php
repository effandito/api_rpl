<?php
  ...
  $status_kp = $_POST['status_kp'];
	...
	$sql=mysqli_query($connect,"INSERT INTO  kp (id_mhs,id_dosen,semester,tahun_kp,jdl_kp,status_kp,nim,nik,tool,spek,alamat,dokumen,penguji,ruangan,lembaga,pimpinan,telp_lembaga,wkt_pel_kp,status_kp) VALUES ('$id_dosen','$id_mhs','$semester','$tahun_kp','$jdl_kp','$status_kp','$nim','$nik','$tool','$spek','$dokumen','$penguji','$ruangan','$lembaga','$pimpinan','$telp_lembaga','$alamat','$wkt_pel_kp')");
	if($sql)
    {
        $response['code'] = 1;
